<script lang="ts">
	...
	$: siteName =
		...
		"Alumni Network";
	$: logoUrl = $settingsStore.settings.find(
		(s) => s.key === "LogoUrl",
	)?.value;
	...
	<header class="bg-white shadow-sm border-b border-gray-200">
		<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
			<div class="flex justify-between items-center h-16">
				...
				<!-- Desktop Navigation - Always show public menus -->
				...
				<div class="hidden md:flex items-center space-x-4">
					...
					{:else}
						<a
							href="/auth/login"
							class="text-gray-700 hover:text-primary-600 px-3 py-2 rounded-md text-sm font-medium flex items-center space-x-1"
						>
							<LogIn class="w-4 h-4" />
							<span>Login</span>
						</a>
						<a
							href="/auth/register"
							class="btn-primary px-4 py-2 text-sm font-medium flex items-center space-x-1"
						>
			...
			<!-- Mobile Navigation - Always show public menus -->
			{#if mobileMenuOpen}
				<div class="md:hidden">
					<div
					...
					>
						...
						{:else}
							...
							>
								...
								<a
									href="/auth/register"
									class="btn-primary block px-3 py-2 rounded-md text-base font-medium text-center"
								>
									Join Network
								</a>
							</div>
			...
			<div class="grid grid-cols-1 md:grid-cols-4 gap-8">
				<div class="col-span-1 md:col-span-2">
					...
					<p class="text-gray-300 mb-4 max-w-md">
						Connect with fellow alumni, discover opportunities, and
						stay updated with your alma mater's latest achievements
						and events.
					</p>
				...
				<div>
					...
					<ul class="space-y-2">
						...
						<li>
							<a
								href="/events"
								class="text-gray-300 hover:text-white">Events</a
							>
						</li>
						<li>
							<a
