<script lang="ts">
    ...
    $: faviconSetting = $settingsStore.settings.find(
        (s) => s.key === "FaviconUrl",
    );
    $: siteNameSetting = $settingsStore.settings.find(
        (s) => s.key === "SiteName",
    );
...
<div class="space-y-6">
    <div>
        ...
        <p class="text-gray-600 mt-1">
            Configure global application settings and appearance
        </p>
    </div>
        ...
        <div class="card">
            ...
            <div class="space-y-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <div class="flex space-x-2">
                            ...
                            {#if logoUrl}
                                <div
                                    class="w-10 h-10 border rounded flex items-center justify-center bg-gray-50"
                                >
                                    <img
                                        src={logoUrl}
                                        alt="Logo preview"
                    ...
                    <div>
                        <label class="form-label" for="faviconUrl"
                            >Favicon URL</label
                        >
                        <input
                            type="text"
                ...
                <div class="pt-6 border-t border-gray-100">
                    <div>
                        <label class="form-label font-bold" for="theme"
                            >Primary Color Theme</label
                        >
                        <p class="text-sm text-gray-600 mb-4">
                            Choose the primary color scheme for the entire
                            application.
                        </p>
                        ...
                        <div class="grid grid-cols-2 sm:grid-cols-4 gap-4">
                            {#each themes as theme}
                                <button
                                    ...
                                    class="relative flex flex-col items-center p-4 rounded-xl border-2 transition-all duration-200 {selectedTheme ===
                                    theme.id
                                        ? 'border-primary-600 bg-primary-50'
                                        : 'border-gray-200 hover:border-gray-300 bg-white'}"
                                >
                                    <div
                                        class="w-12 h-12 {theme.class} rounded-full mb-2 shadow-sm"
                                    ></div>
                                    <span
                                    ...
                                    {#if selectedTheme === theme.id}
                                        <div
                                            class="absolute top-2 right-2 bg-primary-600 rounded-full p-0.5"
                                        >
